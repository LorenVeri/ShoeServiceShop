    ...
    public partial class initdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceHasShoes", x => new { x.ShoesId, x.ServiceId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoin = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "ForeignKey_MemberShip_Customer",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "ForeignKey_Product_ProductImage",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceHasShoesShoesId = table.Column<int>(type: "int", nullable: true),
                    ServiceHasShoesServiceId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Service_ServiceHasShoes_ServiceHasShoesShoesId_ServiceHasShoesServiceId",
                        columns: x => new { x.ServiceHasShoesShoesId, x.ServiceHasShoesServiceId },
                        principalTable: "ServiceHasShoes",
                        principalColumns: new[] { "ShoesId", "ServiceId" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shoes_ServiceHasShoes_ServiceHasShoesShoesId_ServiceHasShoesServiceId",
                        columns: x => new { x.ServiceHasShoesShoesId, x.ServiceHasShoesServiceId },
                        principalTable: "ServiceHasShoes",
                        principalColumns: new[] { "ShoesId", "ServiceId" });
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "StorageId", "ShoesId" });
                    table.ForeignKey(
                        name: "ForeignKey_Customer_Shoes",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetail", x => new { x.OrderId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Service_ServiceHasShoesShoesId_ServiceHasShoesServiceId",
                table: "Service",
                columns: new[] { "ServiceHasShoesShoesId", "ServiceHasShoesServiceId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shoes_CustomerId",
                table: "Shoes",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Shoes_ServiceHasShoesShoesId_ServiceHasShoesServiceId",
                table: "Shoes",
                columns: new[] { "ServiceHasShoesShoesId", "ServiceHasShoesServiceId" });
